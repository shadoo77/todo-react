export default (data) => {
    ...
    if(checkFormType > 7) {
        ...
        const validPassword = data.password.match(strongPasswordRegex);
        ...
        if(validPassword == null) {
            errorObject.passwordError = 'Invalid password !  minimum 8 characters with at least one number, One capital letter and one sympole';
        }
